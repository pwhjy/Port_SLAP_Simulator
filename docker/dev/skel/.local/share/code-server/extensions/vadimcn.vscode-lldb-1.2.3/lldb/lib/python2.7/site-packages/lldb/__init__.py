...
class SBInitializerOptions(_object):
    ...
    def __init__(self, *args):
        """
        __init__(lldb::SBInitializerOptions self) -> SBInitializerOptions
        __init__(lldb::SBInitializerOptions self, SBInitializerOptions rhs) -> SBInitializerOptions
        """
    ...
    def SetCaptureReproducer(self, b):
        """SetCaptureReproducer(SBInitializerOptions self, bool b)"""
        return _lldb.SBInitializerOptions_SetCaptureReproducer(self, b)


    def SetReplayReproducer(self, b):
        """SetReplayReproducer(SBInitializerOptions self, bool b)"""
        return _lldb.SBInitializerOptions_SetReplayReproducer(self, b)


    def SetReproducerPath(self, path):
        """SetReproducerPath(SBInitializerOptions self, str const * path)"""
        return _lldb.SBInitializerOptions_SetReproducerPath(self, path)
